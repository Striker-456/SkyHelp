    ...
    inicializar() {
        ...
        window.addEventListener('popstate', (e) => {
            if (this.usuarioActual && e.state?.seccion) {
                ...
                const titulos = { dashboard:'Dashboard', tickets:'Gestión de Tickets', tecnicos:'Gestión de Técnicos', domiciliarios:'Gestión de Domiciliarios', usuarios:'Gestión de Usuarios', auditoria:'Auditorías', reportes:'Reportes', estadisticas:'Estadísticas', configuracion:'Configuración', perfil:'Mi Perfil', historial:'Historial de Entregas' };
